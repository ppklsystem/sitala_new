...
class simulasiHitungIKAController extends Front
{
            ...
            if ($dataIndeks['total']) {
                ...
                if ($dataIndeksProv['total']) {
                    ...
                    if($tahun[1] < 2025){
                      ...
                      $nilai_indeks_no_bobot = array_sum($nilai_indeks_no_bobot_tmp)/count($nilai_indeks_no_bobot_tmp);
                    }else{
                      $nilai_indeks = array_sum($nilai_indeks_tmp)/count($nilai_indeks_tmp);
                      $nilai_indeks_no_bobot = $nilai_indeks;
                    }
    ...
    {//function for counting data pelaporan
      ...
      $jenis_indeks = $this->params('y');
        ...
        if ($dataIndeks['total']) {
            ...
            $postIdx['form']['json_data'] = $cnIndeks['data'];
            $postIdx['form']['status_hitung'] = 1;

            $postIdx['form']['json_data_ina'] = $cnIndeks2025['data'];
    ...
    //   $data = $this->_countIndekStatusMutu(53613);
